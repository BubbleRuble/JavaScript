...
function openModalWindow({ original, description }) {
...
`,
    {
      onShow: instance => {
        ...
        window.addEventListener('keydown', onModalWindowHandle);
      },
      onClose: instance => {
        console.log('Remove event')
        window.removeEventListener('keydown', onModalWindowHandle);
      },
    },
);
  instance.show();
...
function onModalWindowHandle(e) {
  console.log('test')
  if (e.code === 'Escape') {
    instance.close()
  }
